...
struct oe_conn oe_packet_default = {
	...
	.oe_sc = {
		...
		POLICY_OPPO|POLICY_IKEPAD|POLICY_FAIL_PASS|POLICY_IKEV2_ALLOW,
...
struct oe_conn oe_clear = {
	...
	.oe_cn = "clear",
	.oe_sc = {
		.policy = POLICY_TUNNEL|POLICY_PFS|POLICY_IKEPAD|POLICY_GROUP|POLICY_GROUTED|POLICY_SHUNT_PASS,
...
struct oe_conn oe_clear_or_private = {
	...
	.oe_sc = {
		...
		POLICY_DONT_REKEY|POLICY_IKEPAD|POLICY_OPPO|POLICY_GROUP|POLICY_GROUTED|
...
struct oe_conn oe_private = {
	...
	.oe_sc = {
		.policy = POLICY_RSASIG|POLICY_ENCRYPT|POLICY_TUNNEL|POLICY_PFS|
		POLICY_OPPO|POLICY_IKEPAD|POLICY_GROUP|POLICY_GROUTED|
...
struct oe_conn oe_block = {
	...
	.oe_cn = "block",
	.oe_sc = {
		.policy = POLICY_TUNNEL|POLICY_IKEPAD|POLICY_PFS|
