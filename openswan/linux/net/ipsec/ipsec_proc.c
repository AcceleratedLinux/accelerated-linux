...
int
ipsec_eroute_show(struct seq_file *seq, void *offset)
{
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_spi_format(struct ipsec_sa *sa_p, struct seq_file *seq)
{
	char sa[SATOT_BUF];
	...
	if (sa_p->ips_said.proto == IPPROTO_COMP &&
	   (sa_p->ips_comp_ratio_dbytes ||
		...
		seq_printf(seq, " ratio=%Ld:%Ld",
			       sa_p->ips_comp_ratio_dbytes, sa_p->ips_comp_ratio_cbytes);
	}
#endif /* CONFIG_KLIPS_IPCOMP */
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_spi_show(struct seq_file *seq, void *offset)
{
	int i;
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_spigrp_show(struct seq_file *seq, void *offset)
{
	int i;
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_saraw_show(struct seq_file *seq, void *offset)
{
	struct ipsec_sa *sa_p;
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_tncfg_show(struct seq_file *seq, void *offset)
{
	int i;
	char name[9];
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_version_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_saref_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_ocf_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_natt_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_klipsdebug_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_trap_count_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
...
IPSEC_PROCFS_DEBUG_NO_STATIC
int
ipsec_trap_sendcount_show(struct seq_file *seq, void *offset)
{
	KLIPS_PRINT(debug_tunnel & DB_TN_PROCFS,
