...
/**
 * request_firmware_nowarn_nocache() - request for an optional fw module without caching it
 * @firmware_p: pointer to firmware image
 * @name: name of firmware file
 * @device: device for which firmware is being loaded and DMA region allocated
 *
 * This function is similar in behaviour to firmware_request_nowarn(), except it
 * doesn't cache the firmware.
 */
int request_firmware_nowarn_nocache(const struct firmware **firmware_p,
...
EXPORT_SYMBOL(request_firmware_nowarn_nocache);
