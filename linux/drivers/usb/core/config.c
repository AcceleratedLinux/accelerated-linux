...
#define USB_MAXCONFIG			64	/* Arbitrary limit */
...
#ifdef CONFIG_USB_AWUSB_NUM_PORTS
			/* Telenot AT 3000 reports bNumConfigurations=2 but
			 * only responds to the first configuration
			 * descriptor, so return happy if any configurations
