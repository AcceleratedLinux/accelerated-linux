...
#if 0
	/*
	 * Allowing use of UBI on MLC flash for the OpenGear platforms
	 * that use it. Although this is an error condition here all the
	 * MTD and UBI code allows this to work.
	 */
	/*
