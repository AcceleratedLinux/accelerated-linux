...
static int n25q_post_bfpt_fixups(struct spi_nor *nor,
				 const struct sfdp_parameter_header *bfpt_header,
				 const struct sfdp_bfpt *bfpt)
{
	/*
	 * N25Q* models over 128MB support 3 or 4B opcodes, but require 4 byte
	 * addressing to access > 128MB
...
static struct spi_nor_fixups n25q_fixups = {
	.post_bfpt = n25q_post_bfpt_fixups,
};
