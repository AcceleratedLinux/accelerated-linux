...
uint32_t iegbe_oem_get_dev_number(struct iegbe_hw *hw);
...
int32_t iegbe_oem_write_phy_reg_ex(struct iegbe_hw *hw,
                                   uint32_t reg_addr,
                                   uint16_t phy_data);
int32_t iegbe_oem_read_phy_phy_reg_ex(struct iegbe_hw *hw,
				      uint32_t phy_addr,
				      uint32_t reg_addr,
				      uint16_t *phy_data);
int32_t iegbe_oem_write_phy_phy_reg_ex(struct iegbe_hw *hw,
				       uint32_t phy_addr,
				       uint32_t reg_addr,
				       uint16_t phy_data);
