...
#define	CONFIG_IRQ_PASS_REGS	1
#endif /* < 2.6.19 */

#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,21)
#define	_INIT_WORK(wq,fn,arg)	INIT_WORK(wq,fn)
#define	INITWORK21
#else
#define	_INIT_WORK(wq,fn,arg)	INIT_WORK(wq,(void (*)(void *))fn,arg)
#endif /* > 2.6.21 */
