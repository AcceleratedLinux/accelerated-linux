...
static struct ieee80211_iface_combination
	...
	{
		.limits = wlan_hdd_dbdc_iface_limit,
		.num_different_channels = 2,
		.max_interfaces = 3,
		.n_limits = ARRAY_SIZE(wlan_hdd_dbdc_iface_limit),
	},
};
...
static int ath11k_mac_setup_iface_combinations(struct ath11k *ar)
{
	...
	if (ab->hw_rev == ATH11K_HW_QCA6390_HW20 || ab->hw_rev == ATH11K_HW_WCN6855_HW20 || ab->hw_rev == ATH11K_HW_WCN6855_HW21) {
		ar->hw->wiphy->n_iface_combinations =
				ARRAY_SIZE(wlan_hdd_iface_combination);
		ar->hw->wiphy->iface_combinations = wlan_hdd_iface_combination;
