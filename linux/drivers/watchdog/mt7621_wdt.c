...
static void mt7621_wdt_restart(char *command)
{
	...
	rt_wdt_w32(mt7621_wdt_base, TIMER_REG_TMR1LOAD, 1);
	rt_wdt_w32(mt7621_wdt_base, TIMER_REG_TMRSTAT, TMR1CTL_RESTART);

	t = rt_wdt_r32(mt7621_wdt_base, TIMER_REG_TMR1CTL);
	t |= TMR1CTL_ENABLE;
	rt_wdt_w32(mt7621_wdt_base, TIMER_REG_TMR1CTL, t);
