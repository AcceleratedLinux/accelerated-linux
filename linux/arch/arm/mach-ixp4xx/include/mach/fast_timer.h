...
/* From the old timex.h */
#ifndef CONFIG_IXP4XX_CLOCK
#define CONFIG_IXP4XX_CLOCK 66666000
#endif

#define CLOCK_TICK_RATE \
        (((CONFIG_IXP4XX_CLOCK / HZ & ~IXP4XX_OST_RELOAD_MASK) + 1) * HZ)
...
static int __init fast_timer_setup(void)
{
	...
	*IXP4XX_OSST = IXP4XX_OSST_TIMER_2_PEND;
	...
	if (request_irq(IRQ_IXP4XX_TIMER2, fast_timer_interrupt, 0,
			"fast timer", NULL))
		return -EBUSY;
