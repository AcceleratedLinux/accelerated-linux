/*
 *  linux/include/asm-arm/arch-ks8692/memory.h
 *
...
#define __arch_pfn_to_dma(dev, pfn)	__pfn_to_phys(pfn)
#define __arch_dma_to_pfn(dev, addr)	__phys_to_pfn(addr)
#define __arch_dma_to_virt(dev, addr)	((void *) __bus_to_virt(addr))
#define __arch_virt_to_dma(dev, addr)	__virt_to_bus((unsigned long)(addr))
