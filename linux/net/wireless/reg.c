...
void wiphy_apply_custom_regulatory(struct wiphy *wiphy,
				   const struct ieee80211_regdomain *regd)
{
#ifdef INCLUDE_REGDOMAIN_PATCH_INTRODUCED_IN_KERNEL_5_11
	/*
	 * INCLUDE_REGDOMAIN_PATCH_INTRODUCED_IN_KERNEL_5_11 if not defined in DAL
	 *
	 * This patch in 5.11 seems a regression that it disrupts Wi-Fi driver's
	 * regulatory database loading; resulting with country_code "98"
	 * which cause the auto channel not working in 5G band, in DAL.
	 */
