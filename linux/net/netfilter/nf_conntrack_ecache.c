...
#ifdef CONFIG_NF_CONNTRACK_CHAIN_EVENTS
void nf_conntrack_register_notifier(struct net *net, struct notifier_block *nb)
{
	atomic_notifier_chain_register(&net->ct.nf_conntrack_chain, nb);
}
#else
...
#ifdef CONFIG_NF_CONNTRACK_CHAIN_EVENTS
void nf_conntrack_unregister_notifier(struct net *net, struct notifier_block *nb)
{
	atomic_notifier_chain_unregister(&net->ct.nf_conntrack_chain,
						nb);
}
#else
