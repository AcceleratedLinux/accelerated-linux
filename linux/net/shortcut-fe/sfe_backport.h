...
//#ifdef CONFIG_MODULES_QCA_NSS_ECM
/* If NSS ECM driver is loaded as well, ECM has precedence */
#define SFE_NF_IP_PRIORITY	NF_IP_PRI_NAT_SRC + 2
#define SFE_NF_IP6_PRIORITY	NF_IP6_PRI_NAT_SRC + 2
/*#else
#define SFE_NF_IP_PRIORITY	NF_IP_PRI_NAT_SRC + 1
#define SFE_NF_IP6_PRIORITY	NF_IP6_PRI_NAT_SRC + 1
#endif*/
